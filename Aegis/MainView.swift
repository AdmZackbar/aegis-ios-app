...
#Preview {
    ...
    container.mainContext.insert(Purchase(date: Date(), category: .VideoGame(name: "Baldur's Gate 3", platform: "Steam"), seller: "Adobe", price: .Cents(999)))
    container.mainContext.insert(Purchase(date: Date(), category: .Restaurant(info: "Day trip to Rocktown", tip: .Cents(250)), seller: "Mentone Cafe", price: .Cents(980)))
